...
<div class="content read container">
    ...
    <div class="pagination">
        <?php if ($page > 1) : ?>
            <a href="EventLog.php?page=<?= $page - 1 ?>"><i class="fas fa-angle-double-left fa-sm"></i></a>
        <?php endif; ?>
        <?php if ($page * $records_per_page < $num_Item) : ?>
            <a href="EventLog.php?page=<?= $page + 1 ?>"><i class="fas fa-angle-double-right fa-sm"></i></a>
        <?php endif; ?>
    </div>
    <div class="text-center"> <a href="https://cs2s.yorkdc.net/~william.hill1/here/SensorStatus.php" class="btn btn-primary center-block">Check current Overview</a>
    </div>
</div>
